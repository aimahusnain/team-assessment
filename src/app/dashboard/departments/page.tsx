    ...
    return [
      {
        ...
        header: ({ column }: { column: Column<DepartmentData> }) => (
          <SortableHeader<DepartmentData> column={column} title="Department" />
        ),
        cell: ({ row }: { row: Row<DepartmentData> }) => (
      ...
      },
      {
        ...
        accessorKey: "month",
        header: ({ column }: { column: Column<DepartmentData> }) => (
          <SortableHeader<DepartmentData> column={column} title="Month" />
        ),
        cell: ({ row }: { row: Row<DepartmentData> }) => <div className="font-medium">{row.getValue("month")}</div>,
      },
        ...
        ? [
            {
              ...
              header: ({ column }: { column: Column<DepartmentData> }) => (
                <SortableHeader<DepartmentData> column={column} title="Avg Total Call Minutes" />
              ),
              cell: ({ row }: { row: Row<DepartmentData> }) => (
                <div className="text-right">{row.getValue("avgTotalCallMinutes")}</div>
              ),
            },
          ]
        : []),
      ...(selectedColumns.includes("TCM Score")
        ? [
            {
              id: "tcmScore",
              accessorFn: (row: DepartmentData) => row.tcmScore.level,
              header: ({ column }: { column: Column<DepartmentData> }) => (
                <SortableHeader<DepartmentData> column={column} title="TCM Score" />
              ),
              cell: ({ row }: { row: Row<DepartmentData> }) => (
                <div className="text-center">{row.original.tcmScore.level || "-"}</div>
              ),
            },
          ]
        : []),
        ...
        ? [
            {
              ...
              header: ({ column }: { column: Column<DepartmentData> }) => (
                <SortableHeader<DepartmentData> column={column} title="Avg Call Efficiency" />
              ),
              cell: ({ row }: { row: Row<DepartmentData> }) => (
                <div className="text-right">{row.getValue("avgCallEfficiency")}</div>
              ),
            },
          ]
        : []),
      ...(selectedColumns.includes("CE Score")
        ? [
            {
              id: "ceScore",
              accessorFn: (row: DepartmentData) => row.ceScore.level,
              header: ({ column }: { column: Column<DepartmentData> }) => (
                <SortableHeader<DepartmentData> column={column} title="CE Score" />
              ),
              cell: ({ row }: { row: Row<DepartmentData> }) => (
                <div className="text-center">{row.original.ceScore.level || "-"}</div>
              ),
            },
          ]
        : []),
        ...
        ? [
            {
              ...
              header: ({ column }: { column: Column<DepartmentData> }) => (
                <SortableHeader<DepartmentData> column={column} title="Avg Total Sales" />
              ),
              cell: ({ row }: { row: Row<DepartmentData> }) => (
                <div className="text-right">{row.getValue("avgTotalSales")}</div>
              ),
            },
          ]
        : []),
      ...(selectedColumns.includes("TS Score")
        ? [
            {
              id: "tsScore",
              accessorFn: (row: DepartmentData) => row.tsScore.level,
              header: ({ column }: { column: Column<DepartmentData> }) => (
                <SortableHeader<DepartmentData> column={column} title="TS Score" />
              ),
              cell: ({ row }: { row: Row<DepartmentData> }) => (
                <div className="text-center">{row.original.tsScore.level || "-"}</div>
              ),
            },
          ]
        : []),
        ...
        ? [
            {
              ...
              header: ({ column }: { column: Column<DepartmentData> }) => (
                <SortableHeader<DepartmentData> column={column} title="Avg Ratio Between Skade & Liv" />
              ),
              cell: ({ row }: { row: Row<DepartmentData> }) => (
                <div className="text-right">{row.getValue("avgRatioBetweenSkadeAndLiv")}</div>
              ),
            },
          ]
        : []),
      ...(selectedColumns.includes("RBSL Score")
        ? [
            {
              id: "rbslScore",
              accessorFn: (row: DepartmentData) => row.rbslScore.level,
              header: ({ column }: { column: Column<DepartmentData> }) => (
                <SortableHeader<DepartmentData> column={column} title="RBSL Score" />
              ),
              cell: ({ row }: { row: Row<DepartmentData> }) => (
                <div className="text-center">{row.original.rbslScore.level || "-"}</div>
              ),
            },
          ]
        : []),
        ...
        ? [
            {
              ...
              header: ({ column }: { column: Column<DepartmentData> }) => (
                <SortableHeader<DepartmentData> column={column} title="Avg Total Score" />
              ),
              cell: ({ row }: { row: Row<DepartmentData> }) => (
                <div className="text-right">{formatDecimal(row.getValue("avgTotalScore"))}</div>
              ),
            },
          ]
        : []),
